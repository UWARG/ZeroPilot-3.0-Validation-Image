...
/* Private defines -----------------------------------------------------------*/
#define GPIO_IL_D_Pin GPIO_PIN_2
#define GPIO_IL_D_GPIO_Port GPIOF
#define GPIO_IL_C_Pin GPIO_PIN_3
#define GPIO_IL_C_GPIO_Port GPIOF
...
#define uSD_Detect_Pin GPIO_PIN_11
...
#define GPIO_IL_B_Pin GPIO_PIN_6
#define GPIO_IL_B_GPIO_Port GPIOG
#define GPIO_IL_A_Pin GPIO_PIN_7
#define GPIO_IL_A_GPIO_Port GPIOG
